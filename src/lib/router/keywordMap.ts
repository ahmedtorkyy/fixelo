...
const KEYWORD_TO_SLUG: Record<string, string[]> = {
  ...
  "speaker": ["audio-fix"],
  "headphone": ["audio-fix"],
  "microphone": ["microphone-fix", "audio-fix"],
  "mic": ["microphone-fix", "audio-fix"],
  "volume": ["audio-fix"],
  "quiet": ["audio-fix"],
  "low": ["audio-fix"],
  "mute": ["audio-fix"],
  ...
  "backup": ["auto-backup"],
  "restore": ["auto-backup"],
  "restore point": ["restore-point-manager", "auto-backup"],
  ...
  "free space": ["free-up-space", "monthly-maintenance", "disk-error-fix"],
  "disk cleanup": ["free-up-space", "monthly-maintenance", "disk-error-fix"],
  ...
  "input device": ["keyboard-mouse-fix", "microphone-fix"],
  ...
  "onedrive": ["onedrive-fix", "system-tweaks"],
  ...
  "disable onedrive": ["onedrive-fix", "system-tweaks"],
  ...
  "remove onedrive": ["onedrive-fix", "system-tweaks"],
  ...
  "clean disk": ["free-up-space"],
  "running out of space": ["free-up-space"],
  "no space": ["free-up-space"],
  "full drive": ["free-up-space"],
  "clear space": ["free-up-space"],
  "windows.old": ["free-up-space"],
  "free up space": ["free-up-space"],
  "reclaim space": ["free-up-space"],
  "temp files": ["free-up-space"],

  // === RESTORE POINT MANAGER ===
  "create restore point": ["restore-point-manager"],
  "rollback": ["restore-point-manager"],
  "roll back": ["restore-point-manager"],
  "recovery point": ["restore-point-manager"],
  "safe point": ["restore-point-manager"],
  "undo changes": ["restore-point-manager"],

  // === MICROPHONE FIX ===
  "mic not working": ["microphone-fix"],
  "cant hear me": ["microphone-fix"],
  "no one can hear me": ["microphone-fix"],
  "recording": ["microphone-fix"],
  "headset mic": ["microphone-fix"],
  "teams mic": ["microphone-fix"],
  "zoom mic": ["microphone-fix"],
  "mic muted": ["microphone-fix"],

  // === POWER & SLEEP FIX ===
  "won't sleep": ["power-sleep-fix"],
  "wont sleep": ["power-sleep-fix"],
  "keeps waking": ["power-sleep-fix"],
  "wakes up": ["power-sleep-fix"],
  "random wake": ["power-sleep-fix"],
  "won't shut down": ["power-sleep-fix"],
  "wont shutdown": ["power-sleep-fix"],
  "won't turn off": ["power-sleep-fix"],
  "fast startup": ["power-sleep-fix"],
  "sleep mode": ["power-sleep-fix"],
  "wake timer": ["power-sleep-fix"],
  "power settings": ["power-sleep-fix"],
  "diagnose sleep": ["power-sleep-fix"],
  "sleep problem": ["power-sleep-fix"],

  // === ONEDRIVE FIX ===
  "onedrive sync": ["onedrive-fix", "system-tweaks"],
  "stop onedrive": ["onedrive-fix", "system-tweaks"],
  "onedrive won't sync": ["onedrive-fix"],
  "cloud sync": ["onedrive-fix"],
  "onedrive desktop": ["onedrive-fix", "system-tweaks"],
  "turn off onedrive": ["onedrive-fix", "system-tweaks"],
